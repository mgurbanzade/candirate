    ...
    <>
      <div className="flex justify-between items-center px-4 py-5 sm:px-6">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-white focus:outline-none border-transparent bg-blue-600 hover:bg-blue-700"
        >
          Save
        </button>
      </div>
